...
const LOOT_PETS: Pet[] = [
  {
    ...
    bonusType: 'attack',
    bonusValue: 3,
    desc: '+3 ATK, entfacht Glut bei jedem Angriff (+2 Mana).',
    activeAbility: { trigger: 'onAttack', label: 'Glutfunke', mana: 2 },
  },
  {
    id: 'mistral',
    name: 'Mistral',
    ...
    bonusType: 'crit',
    bonusValue: 5,
    desc: '+5% Crit, Windstoss bei Krit reduziert Cooldown.',
    activeAbility: { trigger: 'onCrit', label: 'Windstoss', cooldownReduce: 1 },
  },
  {
    id: 'spring',
    name: 'Spring',
    ...
    bonusType: 'manaReg',
    bonusValue: 4,
    desc: '+4 Mana, quillt bei jedem Sieg (+8 Mana).',
    activeAbility: { trigger: 'onKill', label: 'Quellsegen', mana: 8 },
  },
  {
    id: 'bastion',
    name: 'Bastion',
    ...
    bonusType: 'defense',
    bonusValue: 4,
    desc: '+4 DEF, Deckung heilt zusaetzlich (+5 HP).',
    activeAbility: { trigger: 'onGuard', label: 'Wall', heal: 5 },
  },
  {
    id: 'clover',
    name: 'Clover',
    ...
    bonusType: 'luck',
    bonusValue: 3,
    desc: '+3 Glueck, seltene Shard-Funde bei Siegen.',
    activeAbility: { trigger: 'onKill', label: 'Gluecksfund', shard: 1 },
  },
  {
    id: 'frostling',
    name: 'Frostling',
    ...
    bonusType: 'crit',
    bonusValue: 4,
    desc: '+4% Crit, Kritzauber baut eine Riposte-Ladung auf.',
    activeAbility: { trigger: 'onCrit', label: 'Frostkonter', riposteCharge: 1 },
  },
  {
    id: 'emberwyrm',
    name: 'Emberwyrm',
    ...
    bonusType: 'attack',
    bonusValue: 5,
    desc: '+5 ATK, jeder Angriff schuert Manahitze (+3 Mana).',
    activeAbility: { trigger: 'onAttack', label: 'Manahitze', mana: 3 },
  },
  {
    id: 'storm-imp',
    name: 'Sturmkobold',
    ...
    bonusType: 'crit',
    bonusValue: 6,
    desc: '+6% Crit, Kettenblitz bei Krit (+4 Mana).',
    activeAbility: { trigger: 'onCrit', label: 'Kettenblitz', mana: 4 },
  },
  {
    id: 'shadow-sprite',
    name: 'Schattengeist',
    ...
    bonusType: 'attack',
    bonusValue: 4,
    desc: '+4 ATK, ernte Seelen bei Siegen (+1 Shard).',
    activeAbility: { trigger: 'onKill', label: 'Seelenernte', shard: 1 },
  },
  {
    id: 'crystal-fox',
    name: 'Kristallfuchs',
    ...
    bonusType: 'defense',
    bonusValue: 3,
    desc: '+3 DEF, heilt bei jedem Sieg (+8 HP).',
    activeAbility: { trigger: 'onKill', label: 'Segnung', heal: 8 },
  },
  {
    id: 'lava-toad',
    name: 'Lavakroete',
    ...
    bonusType: 'attack',
    bonusValue: 6,
    desc: '+6 ATK, brennende Haut heizt Angriffe an (+3 Mana).',
    activeAbility: { trigger: 'onAttack', label: 'Brennhaut', mana: 3 },
  },
  {
    id: 'dusk-owl',
    name: 'Daemmereule',
    ...
    bonusType: 'luck',
    bonusValue: 4,
    desc: '+4 Glueck, deckt bei Krit den naechsten Zug auf (+1 Cooldown-Reset).',
    activeAbility: { trigger: 'onCrit', label: 'Weitblick', cooldownReduce: 1 },
  },
  {
    id: 'iron-crab',
    name: 'Eisenkrabbe',
    ...
    bonusType: 'defense',
    bonusValue: 5,
    desc: '+5 DEF, Panzerung heilt bei Deckung (+6 HP).',
    activeAbility: { trigger: 'onGuard', label: 'Panzerung', heal: 6 },
  },
  {
    id: 'tidecaller',
    name: 'Flutrufer',
    ...
    bonusType: 'manaReg',
    bonusValue: 6,
    desc: '+6 Mana, Flutwelle bei Deckung fuellt Mana (+10 Mana).',
    activeAbility: { trigger: 'onGuard', label: 'Flutwelle', mana: 10 },
  },
];
